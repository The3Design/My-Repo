...
//             description: "A High Quality 3D Model of Tvs Apache. (Blender)",
//             link: "new1.png",
//             // image: "new1.png", // REMOVE the image property for Apache RTR 160 4v 2
//             videoSrc: "videos/apache-rtr-4v2.mp4", // ADD videoSrc for Apache RTR 160 4v 2
//             poster: "video-thumbnails/apache-rtr-4v2-poster.jpg" // OPTIONAL poster for Apache RTR 160 4v 2
//         },
...
//     });
    ...
    //     document.addEventListener("DOMContentLoaded", function () {
    //         const projects = [ /* ... your projects array (updated with videoLink) ... */ ];
    ...
    //             // Start with the basic project HTML
    //             let projectHTML = `
    //                 <img src="${project.image}" alt="${project.title}">
    //                 <h3>${project.title}</h3>
    //                 <p>${project.description}</p>
    ...
    //             // Conditionally add the Video button if videoLink is present and not empty/null
    ...
    //             projectDiv.innerHTML = projectHTML; // Set the combined HTML
    //             projectContainer.appendChild(projectDiv);
    //         });
    //     });
